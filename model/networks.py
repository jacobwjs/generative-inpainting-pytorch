...
class DisConvModule(nn.Module):
    def __init__(self,
        ...
        self.conv3 = dis_conv(cnum*2, cnum*4, 5, 2, 2, weight_norm=weight_norm)
        self.conv4 = dis_conv(cnum*4, cnum*4, 5, 2, 2, weight_norm=weight_norm)
    ...
    def __init__(self, input_dim, output_dim, kernel_size, stride, padding=0,
        ...
        if transpose:
            ...
            self.conv = nn.Conv2d(input_dim, output_dim, kernel_size, stride,
                                  ...
                                  bias=self.use_bias)
            self.gate = nn.Conv2d(input_dim, output_dim, kernel_size, stride,
                                  padding=conv_padding, dilation=dilation,
                                  bias=self.use_bias)
...
#         print("x: ", feat.shape)
#         feat, gate = torch.split(x, x.size(-1)//2, dim=-1)
